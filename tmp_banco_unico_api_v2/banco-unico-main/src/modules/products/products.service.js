...
function prepareProductPayload(input, productIndex, traceLogger = noopTraceLogger) {
  ...
  const preparedProduct = {
    ...
    activeIngredient: normalizeOptionalText(
      input.principioAtivo || input.ingredienteAtivo || input.ingrediente_ativo || input.activeIngredient,
      "activeIngredient",
      traceLogger,
      { productIndex },
    ),
    ...
    department: normalizeOptionalText(
      input.departamento || input.department,
      "department",
      traceLogger,
      { productIndex },
    ),
    category: normalizeOptionalText(
      input.categoria || input.category,
      "category",
      traceLogger,
      { productIndex },
    ),
    subcategory: normalizeOptionalText(
      input.subcategoria || input.subcategory,
      "subcategory",
      traceLogger,
      { productIndex },
    ),
    segment: normalizeOptionalText(
      input.segmento || input.segment,
      "segment",
      traceLogger,
      { productIndex },
    ),
    subsegment: normalizeOptionalText(
      input.subsegmento || input.subsegment,
      "subsegment",
      traceLogger,
      { productIndex },
    ),
