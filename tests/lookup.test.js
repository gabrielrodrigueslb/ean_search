...
describe("GET /lookup/ean/:ean", () => {
  ...
  test("retorna 404 quando nenhuma fonte encontra o EAN", async () => {
    ...
    enrichImportedItem.mockResolvedValue({
      ...
      approvalReason: "Convertize sem resultado. Drogasil sem resultado.",
      fontes_consultadas: {
        convertize_busca: false,
        convertize_skipped: false,
        convertize_skip_reason: null,
        convertize_detalhe: false,
        convertize_busca_error: null,
        drogasil_busca: false,
        drogasil_detalhe: false,
        drogasil_busca_error: null,
        drogasil_skipped: false,
        drogasil_skip_reason: null,
      },
      item: {
        ean: "7898593053571",
        nome_recebido: null,
